...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 04, 2026 at 12:51 PM
...
INSERT INTO `customer` (`customer_id`, `customer_type`, `cust_first_name`, `cust_last_name`, `customer_phoneNo`) VALUES
(1, 'walk_in', NULL, NULL, NULL),
(2, 'online', 'John', 'Smith', '555-1020'),
(3, 'online', 'Emily', 'Carson', '555-1122'),
(4, 'walk_in', NULL, NULL, NULL),
(5, 'online', 'Daniel', 'Scott', '555-2101'),
(6, 'walk_in', NULL, NULL, NULL),
(7, 'online', 'Maria', 'Lopez', '555-3300'),
(8, 'walk_in', NULL, NULL, NULL),
(9, 'online', 'James', 'Walker', '555-8822'),
(10, 'walk_in', NULL, NULL, NULL);
...
(1, 1, 'Classic Burger', 'Food', 0, NULL, 8.50),
...
INSERT INTO `staff` (`staff_id`, `outlet_id`, `first_name`, `last_name`, `role`) VALUES
(1, 1, 'Alice', 'Johnson', 'Manager'),
(2, 1, 'Brian', 'Cooper', 'Manager'),
(3, 1, 'Sarah', 'Lee', 'Sales'),
(4, 1, 'Kevin', 'White', 'Sales'),
(5, 1, 'Sam', 'Rogers', 'Cook'),
(6, 1, 'Daniel', 'Cruz', 'Cook'),
